...
public class SftpVirtualFile extends VirtualFile
{
	...
	private static long DEFAULT_PERMISSIONS = FilePrefUtils.getFilePermission();
	 ...
	 * @param name
	 */
	SftpVirtualFile(SftpVirtualFileManager manager, String name)
	{
	 ...
	 * @param isDirectory
	 */
	SftpVirtualFile(SftpVirtualFileManager manager, String name, boolean isDirectory)
	{
	 ...
	 */
	SftpVirtualFile(SftpVirtualFileManager manager, String name, long modificationMillis)
	{
	 ...
	 * @param size
	 */
	SftpVirtualFile(SftpVirtualFileManager manager, String name, long permissions, long modificationMillis, boolean isDirectory, long size)
	{
	...
	public int compareTo(Object o)
	{
		...
		{
			return this.getName().compareToIgnoreCase(((IVirtualFile) o).getName());
		}
	...
	public boolean equals(Object o)
	{
		...
		{
			SftpVirtualFile obj = (SftpVirtualFile) o;

			return (obj.getAbsolutePath().equals(this.getAbsolutePath()) && obj.getFileManager() == this
					.getFileManager());
		}
	...
	public String getAbsolutePath()
	{
		if (this._path.length() == 0)
		{
			...
			{
				return this._manager.getFileSeparator();
			}
			else
			{
				return this._manager.getFileSeparator() + this._name;
			}
		}
		else
		{
			return this._path + this._manager.getFileSeparator() + this._name;
		}
	}
	...
	{
		// NOTE: this info is not accessible via our SFTP client
		return 0;
	}
