 ...
 */
public class FtpProProtocolManager extends ProtocolManager
{
	 ...
	 * FtpProtocolManager
	 */
	static FtpProProtocolManager _localProtocolManager = new FtpProProtocolManager();
	...
	{
		FtpProVirtualFileManager vfm = new FtpProVirtualFileManager(this);
	...
	{
		return (IVirtualFileManager[]) SyncManager.getSyncManager().getItems(FtpProVirtualFileManager.class);
	}
	 ...
	 */
	public static FtpProProtocolManager getInstance()
	{
