 ...
 */
public class FtpsVirtualFile extends VirtualFile
{
	...
	private FtpsVirtualFileManager _manager;
	 ...
	 * @param name
	 */
	FtpsVirtualFile(FtpsVirtualFileManager manager, String name)
	{
	 ...
	 * @param isDirectory
	 */
	FtpsVirtualFile(FtpsVirtualFileManager manager, String name, boolean isDirectory)
	{
	 ...
	 */
	FtpsVirtualFile(FtpsVirtualFileManager manager, String name, long modificationMillis)
	{
	 ...
	 * @param size
	 */
	FtpsVirtualFile(FtpsVirtualFileManager manager, String name, long modificationMillis, boolean isDirectory, long size)
	{
	 ...
	 * @param isDirectory
	 */
	FtpsVirtualFile(FtpsVirtualFileManager manager, String name, long permissions, long modificationMillis, boolean isDirectory, long size)
	{
	...
	public boolean equals(Object o)
	{
		...
		{
			FtpsVirtualFile obj = (FtpsVirtualFile) o;
