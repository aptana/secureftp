 ...
 */
public class FtpsProtocolManager extends ProtocolManager
{
	 ...
	 * FtpProtocolManager
	 */
	static FtpsProtocolManager _localProtocolManager = new FtpsProtocolManager();
	...
	static
	{
		ImageDescriptor imageDescriptor = SyncingPlugin.getImageDescriptor("icons/ftps.png"); //$NON-NLS-1$
	...
	{
		FtpsVirtualFileManager vfm = new FtpsVirtualFileManager(this);
	...
	{
		return (IVirtualFileManager[]) SyncManager.getSyncManager().getItems(FtpsVirtualFileManager.class);
	}
	...
	{
		return FtpsVirtualFileManager.class.getName();
	}
	 ...
	 */
	public static FtpsProtocolManager getInstance()
	{
